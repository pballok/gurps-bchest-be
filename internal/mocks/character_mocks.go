...
// Attribute provides a mock function for the type MockCharacter
func (_mock *MockCharacter) Attribute(attributeType model.AttributeType) attribute.Attribute {
	ret := _mock.Called(attributeType)
	...
	if returnFunc, ok := ret.Get(0).(func(model.AttributeType) attribute.Attribute); ok {
		r0 = returnFunc(attributeType)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockCharacter_Attribute_Call) Return(attribute1 attribute.Attribute) *MockCharacter_Attribute_Call {
	_c.Call.Return(attribute1)
	return _c
}

func (_c *MockCharacter_Attribute_Call) RunAndReturn(run func(attributeType model.AttributeType) attribute.Attribute) *MockCharacter_Attribute_Call {
	_c.Call.Return(run)
	return _c
}

// Campaign provides a mock function for the type MockCharacter
func (_mock *MockCharacter) Campaign() string {
	ret := _mock.Called()
...
func (_c *MockCharacter_Campaign_Call) Return(s string) *MockCharacter_Campaign_Call {
	_c.Call.Return(s)
	return _c
}
...
// Name provides a mock function for the type MockCharacter
func (_mock *MockCharacter) Name() string {
	ret := _mock.Called()
...
func (_c *MockCharacter_Name_Call) Return(s string) *MockCharacter_Name_Call {
	_c.Call.Return(s)
	return _c
}
...
// Player provides a mock function for the type MockCharacter
func (_mock *MockCharacter) Player() string {
	ret := _mock.Called()
...
func (_c *MockCharacter_Player_Call) Return(s string) *MockCharacter_Player_Call {
	_c.Call.Return(s)
	return _c
}
...
// Points provides a mock function for the type MockCharacter
func (_mock *MockCharacter) Points() int {
	ret := _mock.Called()
...
func (_c *MockCharacter_Points_Call) Return(n int) *MockCharacter_Points_Call {
	_c.Call.Return(n)
	return _c
}
...
// ToModel provides a mock function for the type MockCharacter
func (_mock *MockCharacter) ToModel() model.Character {
	ret := _mock.Called()
	...
	if returnFunc, ok := ret.Get(0).(func() model.Character); ok {
		r0 = returnFunc()
	} else {
...
func (_c *MockCharacter_ToModel_Call) Return(character model.Character) *MockCharacter_ToModel_Call {
	_c.Call.Return(character)
	return _c
}
